...
const Layout = ({ children }: { children: ReactNode }) => (
  <div className="min-h-screen bg-gray-100 flex flex-col">
    <header className="bg-white shadow py-4 px-6 flex items-center justify-between z-30 relative">
      ...
      <nav>
        <a href="#" className="text-emerald-700 font-semibold px-3 py-2 hover:text-emerald-900 transition-colors rounded">เข้าสู่ระบบ</a>
        <a href="#" className="ml-2 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold px-5 py-2 rounded transition">สมัครสมาชิก</a>
      </nav>
    </header>
